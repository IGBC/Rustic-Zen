...
pub trait Material {
     ...
     * none if no new ray.
     */
    fn outcome(&self, direction: &Vector, normal: &Vector, wavelength: f64, alpha: f64, rng: &mut PRNG) -> Option<Vector>;
}
...
impl Material for HQZLegacy {
    fn outcome(&self, direction: &Vector, normal: &Vector, _wavelength: f64, _alpha: f64, rng: &mut PRNG) -> Option<Vector> {
